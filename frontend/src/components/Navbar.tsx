...
export default function Navbar({ user }: { user: User | null }) {
  return (
    <nav className="fixed top-0 right-0 left-0 z-[1030] bg-surface shadow-[0_4px_16px_#f0f2f5] dark:shadow-none">
      <div className="mx-auto flex h-[68px] max-w-[1140px] items-center px-3 2xl:max-w-[1320px]">
        <Image
          src="/images/logo.svg"
          alt="BuddyScript"
          width={169}
          height={35}
          priority
          className="h-auto w-[140px] lg:w-[169px]"
        />

        <form className="relative ml-auto hidden lg:block">
          <svg
            className="absolute top-1/2 left-[18px] -translate-y-1/2 text-muted"
            width="17"
            height="17"
            viewBox="0 0 17 17"
            fill="none"
          ...
          <input
            ...
            className="h-10 w-[424px] rounded-full border border-input bg-input px-[47px] text-[16px] outline-none placeholder:text-black/25 dark:placeholder:text-white/25 hover:border-primary"
          />
        </form>

        <ul className="mr-2 ml-auto hidden items-center md:flex">
          <li className="mx-3">
            <a href="#" className="relative flex h-[68px] items-center px-4">
              ...
              <span className="absolute bottom-0 left-0 h-[2px] w-full bg-nav" />
            </a>
          </li>

          <li className="mx-3">
            <a href="#" className="flex h-[68px] items-center px-4">
              <svg width="26" height="20" viewBox="0 0 26 20" fill="none" className="text-muted">
                <path
                  fill="currentColor"
                  fillRule="evenodd"
                  clipRule="evenodd"
          ...
          <li className="mx-3">
            <span className="flex h-[68px] cursor-pointer items-center px-4">
              <span className="relative">
                <svg width="20" height="22" viewBox="0 0 20 22" fill="none" className="text-muted">
                  <path
                    fill="currentColor"
                    fillRule="evenodd"
                    clipRule="evenodd"
                ...
                <span className="absolute -top-1 -right-2 flex h-[17px] min-w-[17px] items-center justify-center rounded-full border border-white dark:border-surface bg-primary px-1 text-[11px] leading-none text-white">
                  6
                </span>
              </span>
            </span>
          ...
          <li className="mx-3">
            <a href="#" className="flex h-[68px] items-center px-4">
              <span className="relative">
                <svg width="23" height="22" viewBox="0 0 23 22" fill="none" className="text-muted">
                  <path
                    fill="currentColor"
                    fillRule="evenodd"
                    clipRule="evenodd"
